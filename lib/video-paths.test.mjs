...
test("resolves relative video paths against cwd and skips markdown targets", () => {
  ...
  assert.deepEqual(
    extractLocalVideoPaths("合成：fpv-love\\out\\metro_ep_plot\\metro_night_25.mp4（约 5:06）", "C:\\Users\\albin\\Pictures\\yy"),
    ["C:/Users/albin/Pictures/yy/fpv-love/out/metro_ep_plot/metro_night_25.mp4"],
  );
  assert.deepEqual(
  ...
  assert.deepEqual(
    extractLocalVideoPaths("remote https://example.com/clips/demo.mp4", "/home/me/project"),
    [],
  );
});
