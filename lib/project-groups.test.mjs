...
test("project folder names use the last path segment", () => {
  assert.equal(projectFolderName("D:\\workspace\\pi-web"), "pi-web");
  assert.equal(projectFolderName("/home/me/ComfyUI/"), "ComfyUI");
});
