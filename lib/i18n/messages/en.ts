...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "artifact.status.succeeded": "Completed",
    "artifact.status.failed": "Failed",
    "artifact.status.cancelled": "Cancelled",
    "artifact.status.running": "Running",
    "artifact.status.queued": "Queued",
    "artifact.play": "Play {name}",
    "artifact.queue": "Queue {position}",
    "artifact.progress": "ComfyUI progress",
    "artifact.elapsedTime": "Elapsed time",
    "artifact.noArtifacts": "No artifacts",
    "artifact.workflow": "workflow",
    "artifact.openWorkflow": "Open workflow",
    "artifact.rerun": "Rerun",
    "artifact.rerunPrepared": "Rerun request added to the composer. Review it, then send.",
    "artifact.rerunBlocked": "The composer already has a draft or attachment. Send or clear it first.",
    "artifact.rerunPrompt": "Rerun the ComfyUI task above (run ID: {runId}) with the same workflow and generation parameters, then publish the new result as a new ComfyUI card.",
