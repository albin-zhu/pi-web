...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "artifact.status.succeeded": "已完成",
    "artifact.status.failed": "失败",
    "artifact.status.cancelled": "已取消",
    "artifact.status.running": "运行中",
    "artifact.status.queued": "排队中",
    "artifact.play": "播放 {name}",
    "artifact.queue": "队列 {position}",
    "artifact.progress": "ComfyUI 进度",
    "artifact.elapsedTime": "耗时",
    "artifact.noArtifacts": "没有产物",
    "artifact.workflow": "工作流",
    "artifact.openWorkflow": "打开工作流",
    "artifact.rerun": "重跑",
    "artifact.rerunPrepared": "重跑请求已放入输入框，请确认后发送。",
    "artifact.rerunBlocked": "输入框已有草稿或附件，请先发送或清空。",
    "artifact.rerunPrompt": "请重跑上面的 ComfyUI 任务（任务 ID：{runId}），复用相同工作流和生成参数，并把新结果发布为新的 ComfyUI 卡片。",
    "chat.previewVideo": "预览视频",
